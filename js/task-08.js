...
const emailTextEl = document.querySelector('.email-js');
const passwordTextEl= document.querySelector('.password-js');
...
function onFormSubmit(event) {
   ...
   let newUser={};   
    const name = event.currentTarget.elements.email.value;
